...
const ResetPasswordPage = (props) => {
    ...
    return (
        <div className='container d-flex flex-column align-items-center my-5 py-5'>
            ...
            <Input className='my-3 text-center' type='password' style={{ width: "250px" }} placeholder='New Password' />
            <Input className='my-3 text-center' type='password' style={{ width: "250px" }} placeholder='Confirm New Password' />
